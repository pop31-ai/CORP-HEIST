...
def build_all():
    ...
    issues.append(make(1, "PHI-РЫНОК", "Запуск Golden-500", G.GOLD,
        ...
        HS.scene_market_galaxy(1), "АНАЛИТИКА", "Почему PHI управляет всем рынком",
    ...
    issues.append(make(2, "СЕКТОРА", "Ротация TECH → LUXURY", G.CYAN,
        ...
        HS.scene_sector_prism(2), "СТРАТЕГИЯ", "Как ловить горячий сектор",
    ...
    issues.append(make(3, "ШОРТЫ", "Анатомия сквиза", G.RED,
        ...
        HS.scene_short_storm(3), "РИСК", "Шорты: прибыль и катастрофа",
    ...
    issues.append(make(4, "ЦЕНТРОБАНК", "Цикл ставки PHI", G.AMBER,
        ...
        HS.scene_cb_temple(4), "МАКРО", "Читаем цикл Центробанка",
    ...
    issues.append(make(5, "МАГНАТЫ", "Рейтинг богатства", G.GOLD,
        ...
        HS.scene_magnate_hall(5, names=[m["name"] for m in _mg(5, 5)]),
        "РЕЙТИНГ", "Пирамида богатства по золотому сечению",
    ...
    issues.append(make(6, "МАГНАТ ГОДА", "Коронация сезона", G.GOLD,
        ...
        HS.scene_crown_throne(6, name=_mg(6, 1)[0]["name"], worth=_mg(6, 1)[0]["worth"]),
    ...
    issues.append(make(7, "ДЕРИВАТИВЫ", "Опционы на PHI-страйки", G.PURPLE,
        ...
        HS.scene_derivatives_web(7), "ИНСТРУМЕНТ", "Деривативы: плечо на золоте",
    ...
    issues.append(make(8, "БОТЫ", "Живая лента рынка", G.GREEN,
        ...
        HS.scene_bot_swarm(8), "ТЕХНИКА", "Как работают торговые боты",
    ...
    issues.append(make(9, "ГИЛЬДИИ", "Небоскрёбы и войны", G.CYAN,
        ...
        HS.scene_guild_towers(9), "КООП", "Сила гильдии в золотом сечении",
    ...
    issues.append(make(10, "МАРКЕТ-МЕЙКИНГ", "Спред на PHI", G.GOLD,
        ...
        HS.scene_market_maker(10), "ПРО", "Маркет-мейкер: золотой спред",
